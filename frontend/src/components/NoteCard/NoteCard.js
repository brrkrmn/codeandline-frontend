...
const NoteCard = ({ note }) => {
  return (
    <Link to={`/notes/${note.id}`} className="flex flex-col p-2 grow-0 shrink-0 w-[240px] wide:w-[280px] h-[314px] rounded-xl border-1 border-border shadow-small transition hover:drop-shadow-sm">
